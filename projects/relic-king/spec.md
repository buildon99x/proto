...
숫자는 상수와 같아야 한다. "안목"을 "대조 숙련"으로 부르든 배너의 승산 줄은
...
| --- | --- | --- | --- |
| 온보딩 | 조작 안내 | 해체·목록·회수법 3줄(닫아도 진행) | `world-lore.md` §0 |
| 발굴 | 지층·진척 | 표층 = 해체 잔해층 | §4.2 |
| 제보 배너 | 승산·남은 시간 | 신호의 출처, 유예의 뜻 | §4.3, G101 |
| 감정 | 대기 시간 | 대조 = 사람 서명이 필요한 절차 | §2.1 |
| 소장고 | 정원·보존 | 정원이 중복만 먹는 이유 | §4.7 |
| 시설 | 습도·보관소 | 인증 유지비, 해달 | `characters.md` §4 |
| 박물관 | 관람객 수 | 중계 관람, 연고 인구 | §4.1, G98 |
| 시장 | 경매·암시장 | 권원 있는 물건 / 없는 물건 | §3.1~3.2 |
| 도감 | 종·안목 | 초대 회수자 목록, 판 것도 남는다 | §4.5 |
| 순위·기록패 | 자산·전적 | 공개 귀속 원장 | §4.4 |
| 복귀 요약 | 오프라인 성과 | 예외7이 한 일과 **하지 못한 일** | G103 |
| 규칙(📋) | 확률·계수 | 용어 대응표(게임 용어 ↔ 세계 용어) | §8 |
