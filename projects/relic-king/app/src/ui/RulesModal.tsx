import {
  ...
  TIP_FOCUS_DIG_COST_MULT, TIP_FOCUS_DIG_HIT_CHANCE, TIP_MEAN_INTERVAL, TIP_EMERGENCY_CREW_FUNDS_SHARE, TIP_EMERGENCY_CREW_MIN_COST, TIP_EMERGENCY_CREW_HIT_CHANCE,
