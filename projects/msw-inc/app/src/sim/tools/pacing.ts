...
function loopFirst() {
  ...
  console.log(`── 입사 첫 세션 (봇 대본 · ${V17.buffMin ? '입사 첫날 버프' : '첫 파티 대본, 배속 없음'}) ── 월드 시각 / 실제 시각(추정)`);
