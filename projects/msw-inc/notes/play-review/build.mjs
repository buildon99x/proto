...
const EMO_FLOW13 = {
  ...
  // v1.3.1: Lv 14–15는 고참 달팽이 승진 발령 한 번에 잇는다 (둘째 달팽이 기다림과 그냥 진화 단계가 빠졌다)
  fixed: ["curious", "뚫렸다. 그런데 Lv 14–15는 채용으로 안 닿는다. 오렌: 고참 달팽이가 진화하면 Lv 10"],
  "evolve-badge": ["curious", "보라 ▲. 이 진화가 Lv 14–15를 이을 수 있다"],
  "promote-sheet": ["focus", "'그냥 진화로는 Lv 14–15가 그대로예요' 아래 [▲ 승진 발령 · 무료]. 개업권으로 버섯 언덕"],
  "promote-cut": ["delight", "파란 달팽이가 버섯 언덕을 연다. 빨간 빈틈이 21초 만에 닫힌다"],
  road: ["calm", "길이 다 이어진 뒤에 이벤트를 권한다. 빈틈으로 모험가를 밀어 넣지 않는다"],
