...
const ALL = ["intro", "gap", "hire", "dungeon", "evolve", "report", "approval", "promote", "grow", "ch2", "late", "ch5", "ending", "offduty", "codex", "fullclear", "elite", "boss", "bossinv", "rush10", "rush25", "rush40", "split", "box", "recruit", "clearcut"];
