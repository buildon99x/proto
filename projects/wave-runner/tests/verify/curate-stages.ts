 ...
 * ## 완화 순서
 *
 * 조건을 다 만족하는 후보가 3개에 못 미치면 **성격 → 지속 → 밴드 → 드리프트** 순으로
 ...
 * 뾰족함을, 티어 4 에 지속을 요구한다. 먼저 풀면 티어 3 에 370단위짜리 지속형 코스가
 * 들어와 **티어 4 의 정체성이 흐려진다.** 성격(유형 구성)은 그보다 무른 선호다.
 *
 ...
 * 구분되지 않는다. 섹터가 전부 공정해진 뒤로 후보가 900/900 남으므로 조일 여유가 있다.
 */
