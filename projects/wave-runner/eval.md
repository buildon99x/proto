...
| **기체 성격 측정** | 여유 110/80/80/70ms · 길 5.6/5.8/4.7/5.7 (/8, 표준·둔각·예봉·환). 두 축이 각각 40ms · 1.2경로만큼 갈린다 |
...
| 브라우저 플레이테스트 | Stage 클리어(52.99초·게이트 3개·사망 0) · Endless 6599m · 콘솔 오류 0 · 페이지 오류 0 |
