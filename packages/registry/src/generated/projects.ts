...
export const projects = [
  ...
  },
  {
    ...
    "runtime": "static-artifact",
    "version": "0.2.0",
    "summary": "실존 유물을 발굴·감정·소장해 3축 순위(자산·도감·명성) 종합 1위에 오르는 방치형. 유물의 현실 현존 개체 수가 그대로 게임 공급량이고, 세상에 하나뿐인 유물은 제보 레이스에서 먼저 도달한 쪽이 영구히 가진다. 12거점 세계지도를 발굙단이 회차제로 원정하고, 감정소·보관소·박물관·경매장·암시장까지 갖춘 5탭(발굘·소장고·시설·시장·도감) UI로 확장됐다. 클릭 0회로도 8시간·24시간 방치가 실제로 진행되고(자동매각·자동 재투자 기본 켬), 약 9~10일(226~239시간) 방치만으로 엔딩에 도달한다.",
    "tags": [
      "game",
      "idle",
      "incremental",
    ...
    "updatedAt": "2026-09-18T08:51:12+00:00"
  }
