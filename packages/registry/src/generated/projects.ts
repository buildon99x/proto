...
export const projects = [
  ...
  },
  {
    ...
    "runtime": "static-artifact",
    "version": "0.3.0",
    "summary": "실존 유물을 발굴·감정·소장해 3축 순위(자산·도감·명성) 종합 1위에 오르는 방치형. 유물의 현실 현존 개체 수가 그대로 게임 공급량이고, 세상에 하나뿐인 유물은 제보 레이스에서 먼저 도달한 쪽이 영구히 가진다. 12거점 세계지도를 발굴단이 회차제로 원정하고, 감정소·보관소·박물관·경매장·암시장까지 갖춘 5탭(발굴·소장고·시설·시장·도감) UI로 돌아간다. v0.3에서 유물이 280종 → 2000종(검증 1,902종)으로 늘었다 — 메트로폴리탄 미술관 오픈액세스(CC0) 메타데이터를 거점·연대·유물종류로 갈라 만든 종 1,720개를 손으로 쓴 280종 위에 얹었고, 국보·유일 등급은 사람이 판정한 손글씨 쪽에만 둔다. 유물 획득 주기도 20초 → 8초로 줄였다. 클릭 0회로 약 141시간 방치만으로 엔딩에 도달한다.",
    "tags": [
      "game",
      "idle",
      "incremental",
    ...
    "updatedAt": "2026-09-19T08:29:45+00:00"
  }
